...
st.markdown("# 🐝 Colapso das Abelhas - GREENLOG")
...
with col2: futuristic_kpi("Regiões Críticas", "47")

st.subheader("🗺️ Distribuição de Abelhas")
bee_data = pd.DataFrame({"lat": [-23.5, -15, -5], "lon": [-46.6, -55, -40], "densidade": [85, 65, 92]})
